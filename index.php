...
<html>
  ...
  <body>
    ...
    <h1 id="titulo"> Receita-Mouse de Maracujá</h1>
  <figure>
    <img src="foto.jpg" />
    <figcaption>Foto do Mousse de Maracujá</figcaption>
  </figure>
  <h2>Ingredientes</h2>
  <ul>
  ...
  <ol>
    ...
    <li>Misture todos os ingredientes em um liquidificador(exceto as sementes
de maracujá) </li>
    <li>Bata os ingredientes no liquidificador, em potencia máxima, por 2
minutos</li>
    <li>Coloque o mousse em um recipiente e decore-o com as sementes de
maracujá</li>
    <li>Coloque o mousse na geladeira, deixando em refrigeração por
